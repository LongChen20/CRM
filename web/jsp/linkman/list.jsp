...
<FORM id="customerForm" name="customerForm"
      action="${pageContext.request.contextPath }/linkman_listLinkman.action"
      method=post>
                        ...
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    ...
                                    <TD>所属客户：</TD>
                                    <TD>
                                        <select name="lkm_cust_id.cust_id" id="customer">
                    ...
                    <TR>
                        <TD>
                            <TABLE id=grid
                                ...
                                <s:iterator value="rowPage">
                                    <TR
                                            style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                                        <TD><s:property value="lkm_name"/></TD>
                                        <s:if test='lkm_gender == "0"'>
                                            <td>女</td>
                                        </s:if>
                                        <s:elseif test='lkm_gender == "1"'>
                                            <td>男</td>
                                        </s:elseif>
                                        <s:else>
                                            <td></td>
                                        ...
                                        <TD><s:property value="lkm_cust_id.cust_name"/></TD>
                                        ...
                                        <TD>
                                            ...
                                            &nbsp;
                                            <a href="${pageContext.request.contextPath }/linkman_deleteLinkman.action?lkm_id=<s:property value="lkm_id"/>">删除</a>
                                        </TD>
                                    </TR>
                        ...
                        <TD><SPAN id=pagelink>
                            <DIV
                               ...
                               <s:if test="currPage != 1">
                                ...
                                <B>
                                    <s:iterator var="c" begin="1" end="totalPage">
                                        <s:if test="#c == currPage">
                                            <s:property value="#c"/>
                                        </s:if>
                                        <s:else>
                                            <a href="javascript:to_page(<s:property value='#c'/> )"><s:property value="#c"/></a>
                                        </s:else>
                                    </s:iterator>
                                </B>
...
<script type="text/javascript">
    $(this).ready(function(){
        $.post("${pageContext.request.contextPath}/linkman_show.action", function (data) {
            $(data).each(function (k,y) {
                $("#customer").append("<option value='"+y.cust_id+"'>"+y.cust_name+"</option>");
            })
        },"json");
    });
</script>
