...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/customer_customerlist.action"
		method=post>
								...
								<TABLE id=grid
									...
									<TBODY>
										...
										<TR
											...
											<TD>
											<a href="${pageContext.request.contextPath }/customer_updatecustomer?cust_id=${cust_id}">修改</a>
											&nbsp;&nbsp;
											<a href="${pageContext.request.contextPath }/customer_deletecustomer?cust_id=${cust_id}">删除</a>
											</TD>
										</TR>
											</s:iterator>
									</TBODY>
