...
<BODY>
<FORM id=form1 name=form1 onsubmit="javascript:return WebForm_OnSubmit();" action="${ pageContext.request.contextPath }/user_login.action" method=post target="_parent">
                            ...
                            <TR>
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <tr>
                                            <TH><a href="${pageContext.request.contextPath}/regist.jsp">去注册</a></TH> <th><a href="${pageContext.request.contextPath}/home.htm"> 回首页</a></th>
                                        </tr>
                                        </TBODY>
                                    </TABLE>
                                </TD>
